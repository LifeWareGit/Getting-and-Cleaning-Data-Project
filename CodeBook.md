...
The "raw" data set that was used as input for this initial analysis consisted of a collection of data files.  According to the original documentation associated with the raw data, the data was collected by observing 30 volunteers within an age range of 19-48 years. Each volunteer performed six different activities (WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING) while wearing a smartphone (Samsung Galaxy S II) on their waist. Using the phone's embedded accelerometer and gyroscope, the 3-axial linear acceleration and 3-axial angular velocity measurements were collected at a constant rate of 50Hz resulting in a total of 561 different features/variables being captured for each observation. Although the original experiment produced 561 distinct variables across the six activities for each of the 30 volunteers, for the purposes of this analysis, only the standard deviation and mean feature values were extracted and subsequently processed.
...
In accordance with the course project instructions, the following variables found in the analysis_summary.txt tidy data set represent the average of all the mean and standard deviation variables extracted out of the original unprocessed raw files. Each row/observation of the summary data set correlates the subject/volunteer being observed to one of the six activities previously mentioned for a total of 180 averaged observations. In the list below, every variable name ending in "-XYZ" represents a set of three different measurements taken along the X, Y, and Z axis respectively.  Additionally, the prefix ’t’ before prepended to specific variables represents measurements capture within the time domain, while the 'f' represents measurements captured within the frequency domain.  Also, for clarity, "Acc" stands for a measurement taken from the accelerometer, while "Gyro" of course stands for measurements associated with the phones embedded gyroscope.
